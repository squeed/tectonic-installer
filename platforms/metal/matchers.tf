...
resource "matchbox_group" "controller" {
  ...
  metadata {
    ...
    ign_origin_node_config_json            = "${jsonencode(module.ignition_masters.origin_node_config)}"
  }
}
...
resource "matchbox_group" "worker" {
  ...
  metadata {
    ...
    ign_origin_node_config_json                 = "${jsonencode(module.ignition_workers.origin_node_config)}"
  }
}
