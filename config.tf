...
variable "tectonic_container_images" {
  ...
  default = {
    ...
    kube_core_renderer                   = "quay.io/coreos/kube-core-renderer-dev:d0fcac0d3fe7bf1de99b2b180d84186cd42b38ab"
    ...
    tectonic_ingress_controller_operator = "quay.io/coreos/tectonic-ingress-controller-operator-dev:26a88c3075b8199e07107380a2952a4f1855c325"
